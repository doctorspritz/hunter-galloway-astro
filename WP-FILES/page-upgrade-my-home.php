...
<section class="guide_box">
  <div class="first_block">
    <div>
      <div>
        <h1>The ultimate guide to upgrading your home</h1>
        <p>Everything you need to know about upgrading your home, whether you’re thinking about renovating or looking to buy a new home.</p>
      </div>
      <div class="img_wrap">
    ...
    <div>
      <p>If you’re starting to think about upgrading to a bigger home, or renovating your current home, this is the place for you.</p>
    </div>
  </div>
  ...
  <div class="second_block">
    ...
    <ol>
      <li>
        <span>1</span>
        <a href="#guide_first">Are you ready for an upgrade?</a>
      </li>
      <li>
        <span>2</span>
        <a href="#guide_second">Renovating your home</a>
      </li>
      <li>
        <span>3</span>
    ...
    <p>Want to read all info in one place? Check our <a href="/upgrading-your-home/">ultimate guide to upgrading your home.</a></p>
  </div>

  <div class="third_block">
    <ol>
      <li id="guide_first">
        <h3>Are you ready for an upgrade?</h3>
        <div>
          <div class="img_wrap">
          ...
          <div>
            <p>
                So you’re thinking about an upgrade. Maybe you’ve got a growing family and you need a bit more space. 
                Or maybe your ready to move out from your starter home and into your forever home. 
                Or maybe you just want to do a bit of renovation to freshen the place up. Whatever the reason, these resources will help you to decide if you’re ready:
            </p>
            <ul class="sub_list">
              <li>
                <a target="_blank" href="/upgrading-your-home/">Buy, Build, or Renovate? The ultimate guide to upgrading your home</a>
              </li>
              <li>
      ...
      <li id="guide_second">
        ...
        <div>
          <div class="img_wrap">
            <img class="desk_photo" src="<?php echo get_template_directory_uri(); ?>/images/guide/renovate_kitchen.png" alt="house" />
            <img class="mob_photo" src="<?php echo get_template_directory_uri(); ?>/images/guide/renovate_kitchen_mob.png" alt="house" />
          </div>
          <div>
            <p>
                Planning on renovating? These resources will help you to plan out your renovation and make sure you’ve got enough funds to get it done without the financial stress. 
            </p>
            <ul class="sub_list">
              <li>
                <a target="_blank" href="/renovation-loan/">The complete guide to renovation loans</a>
              </li>
              <li>
                <a target="_blank" href="/kitchen-renovations/">Kitchen renovations: The ultimate guide</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <li id="guide_third">
        ...
        <div>
          ...
          <div>
            ...
            <ul class="sub_list">
              <li>
                <a target="_blank" href="/brisbane-property-market/">Brisbane property market update</a>
              </li>
              <li>
        ...
        <div class="accordion_holder">
          ...
          <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
            ...
            <div class="et_pb_toggle_content clearfix">
              ...
              <ul class="inner_list">
                <li><a href="/property-investor-portfolio/">Are you a First Time Investor who wants to build a portfolio?</a></li>
