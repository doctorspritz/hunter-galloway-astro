...
<div id="main-content" class="lp">
  <div id="main-content" class="lp">
      ...
      <div class="container">
        <div class="lp-header__inner">
          <div class="lp-header__left">
            <h1 class="lp-header__title lp-header__title--desk">Lower Your Rate and Reduce Your Payments Now</h1>
            <div class="lp-header__description">
              Get a personalised refinance assessment within 4 business hours. We'll find you the best rates and terms from our network of 30+ lenders. 97% success rate.
            </div>
            <div class="lp-header__action">
              <button class="lp-header__btn btn_yellow rc_open pum-trigger" data-button="form-popup"><span class="mob">Get My Tailored Loan Plan</span><span class="desktop">Get Your Free Refinance Plan</span></button>
            </div>
          ...
          <div class="lp-header__right">
            <picture class="lp-header__img">
              <source srcset="<?php echo esc_url($image_path . 'lp-4-cover-mob.webp') ?>" media="(max-width: 992px)">
              <source srcset="<?php echo esc_url($image_path . 'lp-4-cover.webp') ?>" media="(min-width: 993px)">
              <img src="<?php echo esc_url($image_path . 'lp-4-cover.webp') ?>" alt="" width="560" height="500" loading="lazy">

            </picture>
            <h2 class="lp-header__title lp-header__title--mob">Lower Your Rate and Reduce Your Payments Now</h2>
      ...
      <div class="container">
        <div class="lp-info__inner">
          ...
          <div class="lp-info__content">
            <h2 class="lp-info__title">Increase Your Savings by Refinancing with Hunter Galloway</h2>
            <div class="lp-info__description">With a 97% success rate, our dedicated team has helped over 3,500 homeowners secure lower rates and better terms. Let us find the perfect refinancing plan for you.</div>

            <div class="lp-info__actions"><button class="btn_yellow rc_open pum-trigger" data-button="form-popup">Estimate Your Refinance Savings</button></div>
          </div>
          <picture class="lp-info__bg">
            ...
            <img src="<?php echo esc_url($image_path . 'lp-2-info-1.webp') ?>" alt="" width="588" height="392" loading="lazy">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="lp-info__inner">
          <picture class="lp-info__bg">
            ...
            <source srcset="<?php echo esc_url($image_path . 'lp-2-info-2.webp') ?>" media="(min-width: 993px)">
            <img src="<?php echo esc_url($image_path . 'lp-2-info-2.webp') ?>" alt="" width="588" height="392" loading="lazy">
          </picture>
          <div class="lp-info__content">
            <h2 class="lp-info__title">Your Refinance, Tailored to Your Goals</h2>
            <div class="lp-info__description">Lower your payments, access equity, switch loan types, or consolidate debt. We'll work closely with you to understand your needs and tailor a refinancing solution that secures the best rates and terms from our 30+ lenders.</div>

            <div class="lp-info__actions"><button class="btn_yellow rc_open pum-trigger" data-button="form-popup">Get Your Refinance Plan</button>
            </div>
          </div>
    ...
    <section class="lp__goals lp-goals">
      <div class="container">
        <h2 class="lp-goals__title">What Do You Need <br> Refinancing For?</h2>
        ...
        <div class="lp-goals__blocks">
          <div class="lp-goals__block goal-block">
            <h3 class="goal-block__title">Lower Your Interest Rate</h3>
            <div class="goal-block__description">Refinance to secure a better rate and reduce your monthly payments.</div>
            <div class="goal-block__action"><button class="rc_open pum-trigger" data-button="form-popup">See How Much You Can Save</button></div>
          </div>
          <div class="lp-goals__block goal-block">
            <h3 class="goal-block__title">Access Your Home Equity</h3>
            <div class="goal-block__description">Use the equity you've built up to fund renovations, investments, or other needs.</div>
            <div class="goal-block__action"><button class="rc_open pum-trigger"  data-button="form-popup">Explore Your Equity Options</button></div>
          </div>
          <div class="lp-goals__block goal-block">
            <h3 class="goal-block__title">Consolidate Your Debts</h3>
            <div class="goal-block__description">Combine multiple debts into one manageable loan with a potentially lower interest rate.</div>
            <div class="goal-block__action"><button class="rc_open pum-trigger" data-button="form-popup">Simplify Your Finances</button></div>
          </div>
          <div class="lp-goals__block goal-block">
            <h3 class="goal-block__title">Switch to a Better Loan</h3>
            <div class="goal-block__description">Find a loan with features that better suit your needs, like flexible repayment options or an offset account.</div>
            <div class="goal-block__action"><button class="rc_open pum-trigger" data-button="form-popup">Find a Better Loan</button></div>
          </div>
          <div class="lp-goals__block goal-block">
            <h3 class="goal-block__title">Fund Your Dream Renovation</h3>
            <div class="goal-block__description">Tap into your equity and make your home renovation dreams a reality.</div>
            <div class="goal-block__action"><button class="rc_open pum-trigger" data-button="form-popup">Plan Your Renovation</button></div>
          </div>
          <div class="lp-goals__block goal-block">
            <h3 class="goal-block__title">Invest in Your Future</h3>
            <div class="goal-block__description">Use your home equity to fund new opportunities and grow your wealth.</div>
            <div class="goal-block__action"><button class="rc_open pum-trigger" data-button="form-popup">Explore Investment Options</button></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="lp__info lp-info">
      <div class="container">
        <div class="lp-info__inner">
          ...
          <div class="lp-info__content">
            <h2 class="lp-info__title">We Do the Paperwork, You Get the Savings</h2>
            <div class="lp-info__description">Hunter Galloway takes care of the tedious paperwork and loan comparisons. We'll secure you the best refinance deal while you focus on what matters most. </div>
            <div class="lp-info__subtitle" style="display: none"></div>
            <ul class="lp-info__list">
              <li>
                <div><span>We Handle the Application:</span> We'll guide you through the process, minimizing your paperwork burden.</div>
              </li>
              <li>
                <div><span>Secure Online Portal:</span> Our user-friendly portal streamlines document collection and keeps everything organized.</div>
              </li>
              <li>
                <div><span>One-on-One Support:</span> Your personal refinance specialist will handle the heavy lifting, keeping you informed every step of the way.</div>
              </li>
            </ul>
            <div class="lp-info__actions"><button class="btn_yellow rc_open pum-trigger" data-button="form-popup">Ditch the Paperwork, Get a Quote</button></div>
          </div>
    ...
    <section class="lp__journey lp-journey">
      <div class="container">
        <h2>Refinance in Four Simple Steps:</h2>
        <div class="lp-journey__steps">
          <div class="lp-journey__step journey-step journey-step--active">
            ...
            <div class="journey-step__description">We review your current loan and finances. This helps us find potential savings.</div>
            <div class="journey-step__actions"><button class="header__assessment btn_yellow rc_open pum-trigger" data-button="form-popup">Get a Free Assessment</button></div>
          </div>
          <div class="lp-journey__step journey-step">
            ...
            <div class="journey-step__description">You receive a personalized refinance plan. This plan outlines better rates, repayments, and loan features.</div>
          </div>
          <div class="lp-journey__step journey-step">
            <div class="journey-step__order ">STEP 3</div>
            <div class="journey-step__title">Information Session</div>
            <div class="journey-step__description">Our experts explain your options. We answer your questions and help you choose the right solution.</div>

          </div>
          <div class="lp-journey__step journey-step">
            <div class="journey-step__order ">STEP 4</div>
            <div class="journey-step__title"><span class="desktop">Settlement</span><span class="mob">Next Steps</span></div>
            <div class="journey-step__description">We manage the entire application and settlement process. You stay informed throughout.</div>
  ...
  <script>
    function handleRefinanceButtonsClick() {
      const refinancePopupBtns = document.querySelectorAll('[data-button="form-popup"]')
      refinancePopupBtns.forEach(btn => {
        btn.addEventListener('click', (event) => {
          const assessmentPopup = document.getElementById('popmake-11791');
          document.querySelector('[data-type="refinance"] input')?.click()
        });
      })
    }

    handleRefinanceButtonsClick();
  </script>
  <?php get_footer();
