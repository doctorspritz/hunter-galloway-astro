...
?>
<div id="main-content" class="covid-main-content">
    <section class="hero_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h1 class="hero_title">Australian Property Market with COVID-19</h1>

                <p class="hero_subtitle">The coronavirus pandemic has the potential to massively disrupt our economy. What does that mean for you and your mortgage?</p>
    ...
    <section class="text_widget text_width_widget widget pt-widget pb-widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">COVID-19 is disrupting almost every industry, including the housing market</h2>
                <p>The impact of coronavirus (COVID-19) is creating challenges for everyone. You may know friends that have had their work hours decreased, or even stood down and mortgage stress has increased, with <span class="text-bold">over 200,000 households</span> added to the stressed list, and with more to come.</p>
                <p>Economists are predicting a drop in housing prices anywhere from <span class="text-bold">5-20%</span> depending on the length and severity of the disruption to our economy.   </p>
                <p>In times like these, it’s normal to feel uncertain about your financial future.</p>
                <p>We want to make sure that you’re aware of your options for support and assistance during this difficult time, and show you some ways that you can reduce your mortgage repayments or restructure your loan.</p>
                <p>Read on to learn about your options. And if you ever need any help, let us know. We’re all in this together and the Hunter Galloway team is here to support you in any way we can.</p>
            </div>
        </div>
    </section>
    ...
    <section class="risk_widget refinance_risk_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">Refinancing your home loan can help </h2>
    ...
    <section class="text_widget text_width_widget widget pt-widget pb2-widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">What to do if you are running into financial difficulties</h2>
                <p>If you are unable to afford your loan repayments due to financial issues during this time, talk to your bank. All banks are offering to allow you to stop making repayments on your home loan for up to six months.</p>
                <p>This interest will be capitalised, which means it continues to accrue on the whole amount during this time and you will end up paying back more money. You can either increase repayments or extend the period of the loan.</p>
                <p>Contact your bank’s hardship team to confirm how they can help if you are in this situation, or download a list of the banks contact numbers <a href="/wp-content/uploads/2020/04/hardship-contact-details.pdf" class="text_underline">here.</a></p>
            </div>
        </div>
    </section>

    <section class="time_essence_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">Time is of the essence</h2>
                <p class="subtitle">There is a short window of time to take action, so act now.</p>
    ...
    <section class="reputation_widget pb2-widget widget">
        <div class="container">
            <div class="inner_widget">
    ...
    <section class="dark_btn_widget widget">
        <div class="container">
            <div class="inner_widget">
                <div class="btn_wrap">
                    <a class="btn_yellow rc_open G-trigger" href="#">Let us know how we can help</a>
                </div>
            </div>
        </div>
    </section>
