  ...
  <div id="main-content" class="lp">
      ...
      <div class="container">
        <div class="lp-header__inner">
          <div class="lp-header__left">
            <h1 class="lp-header__title lp-header__title--desk">Ready to Upgrade? We Make Financing Simple</h1>
            <div class="lp-header__description">
              With a 97% loan approval rate and access to over 30 Australian banks and lenders, Hunter Galloway simplifies the journey to upgrading your home, giving you more options and higher chances of success.
            </div>
            <div class="lp-header__action">
              <button class="lp-header__btn btn_yellow rc_open pum-trigger">Get My Free Home Loan Assessment</button>
            </div>
          ...
          <div class="lp-header__right">
            <picture class="lp-header__img">
              <source srcset="<?php echo esc_url($image_path . 'lp-2-cover-mob.webp') ?>" media="(max-width: 992px)">
              <source srcset="<?php echo esc_url($image_path . 'lp-2-cover.webp') ?>" media="(min-width: 993px)">
              <img src="<?php echo esc_url($image_path . 'lp-2-cover.webp') ?>" alt="" width="560" height="500" loading="lazy">

            </picture>
            <h2 class="lp-header__title lp-header__title--mob">Ready to Upgrade? We Make Financing Simple</h2>
      ...
      <div class="container">
        <div class="lp-info__inner">
          ...
          <div class="lp-info__content">
            <h2 class="lp-info__title">Turn Your Home Equity into Your Dream Upgrade</h2>
            <div class="lp-info__description">Fund your renovation, extension, or rebuild by unlocking the value in your current home. We make it simple and secure.</div>
            <div class="lp-info__subtitle">Equity Benefits:</div>
            <ul class="lp-info__list">
              <li>
                <div><span>Access More Funds:</span> Tap into your home's equity to potentially fund a larger or more ambitious upgrade.</div>
              </li>
              <li>
                <div><span>Expert Guidance:</span> We'll help you navigate the complexities of equity release and make informed decisions.</div>
              </li>
              <li>
                <div><span>Personalised Planning:</span> We'll create a tailored plan to help you achieve your specific upgrade goals.</div>
              </li>
            </ul>
            <div class="lp-info__actions"><button class="btn_yellow rc_open pum-trigger">Get Your Free Equity Assessment</button></div>
          </div>
      ...
      <div class="container">
        <div class="lp-info__inner">
          <picture class="lp-info__bg">
            ...
            <img src="<?php echo esc_url($image_path . 'lp-2-info-2.webp') ?>" alt="" width="560" height="500" loading="lazy">
          </picture>
          <div class="lp-info__content">
            <h2 class="lp-info__title">Renovate Smartly with a Loan Tailored to You</h2>
            <div class="lp-info__description">Make your dream renovation a reality. We'll help you choose the right loan features to maximize your budget and create your perfect space.</div>
            <div class="lp-info__subtitle">Key Features:</div>
            <ul class="lp-info__list">
              <li>
                <div><span>Access Extra Funds:</span> Need a budget boost mid-renovation? Access your additional repayments for unexpected costs or that must-have upgrade.</div>
              </li>
              <li>
                <div><span>Expert Guidance:</span> We'll help you navigate the complexities of equity release and make informed decisions.</div>
              </li>
              <li>
                <div><span>Flexible Repayments:</span> Enjoy peace of mind with a repayment schedule tailored to your budget and lifestyle.</div>
              </li>
            </ul>
    ...
    <section class="lp__info lp-info ">
      <div class="container">
        <div class="lp-info__inner">
          ...
          <div class="lp-info__content">
            <h2 class="lp-info__title">How Much Can You Really Afford for Your Upgrade?</h2>
            <div class="lp-info__description">Find out with a personalized assessment from Hunter Galloway. We'll help you understand your true borrowing power and secure the best loan for your dream renovation, extension, or new home.</div>
            <div class="lp-info__subtitle" style="display: none;"></div>
            <ul class="lp-info__list">
              <li>
                <div><span>Unlock Your Affordability:</span> We'll analyze your financial situation to determine a realistic and comfortable budget for your upgrade.</div>
              </li>
              <li>
                <div><span>Tailored Loan Options:</span> We offer a wide range of loans, including low-deposit options and those that don't require Lender's Mortgage Insurance (LMI), to fit your specific needs.</div>
              </li>
            </ul>
            <div class="lp-info__actions"><button class="btn_yellow rc_open pum-trigger">Get Your Free Equity Assessment</button></div>
          </div>
          <picture class="lp-info__bg">
            <source srcset="<?php echo esc_url($image_path . 'lp-2-info-3-mob.webp') ?>" media="(max-width: 992px)">
            <source srcset="<?php echo esc_url($image_path . 'lp-2-info-3.webp') ?>" media="(min-width: 993px)">
            <img src="<?php echo esc_url($image_path . 'lp-2-info-3.webp') ?>" alt="" width="560" height="500" loading="lazy">
          </picture>
        </div>
      </div>
    </section>
    <section class="lp__info lp-info">
      <div class="container">
        <div class="lp-info__inner">
          <picture class="lp-info__bg">
            <source srcset="<?php echo esc_url($image_path . 'lp-2-info-4-mob.webp') ?>" media="(max-width: 992px)">
            <source srcset="<?php echo esc_url($image_path . 'lp-2-info-4.webp') ?>" media="(min-width: 993px)">
            <img src="<?php echo esc_url($image_path . 'lp-2-info-4.webp') ?>" alt="" width="560" height="500" loading="lazy">
          </picture>
          <div class="lp-info__content">
            <h2 class="lp-info__title">Upgrade Your Home, Not Your Stress Levels</h2>
            <div class="lp-info__description">Hunter Galloway's expert guidance and tailored financing solutions make your upgrade journey smooth, affordable, and enjoyable.</div>
            <div class="lp-info__subtitle">Financial Peace of Mind:</div>
            <ul class="lp-info__list">
              <li>
                <div><span>Master Your Budget:</span> We'll help you create a realistic budget, factoring in your equity, savings, and tailored loan options for maximum flexibility.</div>
              </li>
              <li>
                <div><span>Prepare for the Unexpected:</span> We'll show you how to build a contingency fund and utilize loan features like offset accounts to manage unforeseen costs.</div>
              </li>
              <li>
                <div><span>Protect Your Lifestyle:</span> With over 2,000 satisfied clients, we understand how to align your upgrade financing with your financial goals, ensuring you maintain your lifestyle with confidence.</div>
              </li>
            </ul>
            <div class="lp-info__actions"><button class="btn_yellow rc_open pum-trigger">Get Your Free Equity Assessment</button></div>
          </div>
      ...
      <div class="container">
        <div class="lp-join__block join-block">
          ...
          <div class="join-block__actions">
            <a href="https://www.huntergalloway.com.au/mortgage-calculator/" class="btn_yellow">Calculate My Borrowing Capacity</a>
      ...
      <div class="container">
        ...
        <div class="lp-journey__steps">
          <div class="lp-journey__step journey-step journey-step--active">
            ...
            <div class="journey-step__title"><span class="mob">Free Consultation</span><span class="desktop">Consultation</span></div>
            <div class="journey-step__description">Discuss your vision for your upgraded home and evaluate your current financial situation. We'll explore your options, whether renovating, extending, or buying new, and determine the best path forward together.</div>
            <div class="journey-step__actions"><button class="header__assessment btn_yellow rc_open pum-trigger">Get a Free Consultation</button></div>
          </div>
          <div class="lp-journey__step journey-step">
            ...
            <div class="journey-step__description">Receive a customized Upgrade Plan detailing your financing options, estimated repayments, and a realistic budget, tailored to your chosen path: renovation, extension, or buying new.</div>
          </div>
          <div class="lp-journey__step journey-step">
            <div class="journey-step__order ">STEP 3</div>
            <div class="journey-step__title">Expert Loan Matching </div>
            <div class="journey-step__description">We'll present you with tailored loan options from our network of over 30 lenders, simplifying the process and addressing any complexities in your financial situation.</div>

          </div>
          <div class="lp-journey__step journey-step">
            <div class="journey-step__order ">STEP 4</div>
            <div class="journey-step__title">Seamless Transition</div>
            <div class="journey-step__description"> If you're buying new, we'll secure pre-approval to strengthen your offers. If renovating or extending, we'll provide ongoing support throughout your project, answering your questions, liaising with lenders, and providing expert advice.</div>
