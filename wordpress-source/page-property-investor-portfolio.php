...
<style>
  ...
  .third_block>ol::before {
    ...
    width: 100%;
    height: 85%;
    background: url("<?php echo get_template_directory_uri(); ?>/images/guide/investors_line.svg");
  ...
  #guide_second>div ul.sub_list li,
  #guide_fourth>div ul.sub_list li,
  #guide_fifth>div ul.sub_list li {
    width: 100%;
  }

  #guide_third>div ul.sub_list li,
  #guide_sixth>div ul.sub_list li,
  #guide_seventh>div ul.sub_list li {
    width: 48%;
  }
  ...
  #guide_second>div>div:not(.img_wrap) {
    width: 47%;
  }

  #guide_fourth>div .img_wrap {
    max-width: 312px;
    width: 45%;
  }

  #guide_fourth>div>div:not(.img_wrap) {
    width: 54%;
  }

  #guide_fifth>div .img_wrap {
    order: 2;
    margin: 0 0 0 30px;
    max-width: 416px;
    width: 45%;
  ...
  #guide_fifth>div>div:not(.img_wrap) {
    width: 54%;
  }

  #guide_seventh>div .img_wrap {
    margin: 30px 0 0;
    max-height: 135px;
  }
  ...
  #guide_sixth div ul.sub_list li:nth-child(1) {
    order: 1;
  }

  #guide_sixth div ul.sub_list li:nth-child(2) {
    order: 3;
  }

  #guide_sixth div ul.sub_list li:nth-child(3) {
    order: 5;
  }

  #guide_sixth div ul.sub_list li:nth-child(4) {
    order: 7;
  }

  #guide_sixth div ul.sub_list li:nth-child(5) {
    order: 9;
  }

  #guide_sixth div ul.sub_list li:nth-child(6) {
    order: 2;
  }

  #guide_sixth div ul.sub_list li:nth-child(7) {
    order: 4;
  }

  #guide_sixth div ul.sub_list li:nth-child(8) {
    order: 6;
  }

  #guide_sixth div ul.sub_list li:nth-child(9) {
    order: 8;
  }

  #guide_sixth div ul.sub_list li:nth-child(10) {
    order: 10;
  }

  #guide_seventh div ul.sub_list li:nth-child(1) {
    order: 1;
  }

  #guide_seventh div ul.sub_list li:nth-child(2) {
    order: 3;
  }

  #guide_seventh div ul.sub_list li:nth-child(3) {
    order: 5;
  }

  #guide_seventh div ul.sub_list li:nth-child(4) {
    order: 7;
  }

  #guide_seventh div ul.sub_list li:nth-child(5) {
    order: 9;
  }

  #guide_seventh div ul.sub_list li:nth-child(6) {
    order: 11;
  }

  #guide_seventh div ul.sub_list li:nth-child(7) {
    order: 13;
  }

  #guide_seventh div ul.sub_list li:nth-child(8) {
    order: 2;
  }

  #guide_seventh div ul.sub_list li:nth-child(9) {
    order: 4;
  }

  #guide_seventh div ul.sub_list li:nth-child(10) {
    order: 6;
  }

  #guide_seventh div ul.sub_list li:nth-child(11) {
    order: 8;
  }

  #guide_seventh div ul.sub_list li:nth-child(12) {
    order: 10;
  }

  #guide_seventh div ul.sub_list li:nth-child(13) {
    order: 12;
  }
...
<section class="guide_box">
  <div class="first_block">
    <div>
      <div>
        <h1>The ultimate guide to property investment</h1>
        <p>Accurate and reliable information is critical to investing in property.</p>
      </div>
      <div class="img_wrap">
    ...
    <div>   
      <p>
        Investing in property is one of the best ways to increase your wealth and set yourself up for the future.
        With the right property and financing, your assets will appreciate in value while returning a profitable yield from rental income. 
      </p>
      <p>These resources will help you maximise your chances of finding a profitable investment property.</p>
    </div>
  </div>
  ...
  <div class="second_block">
    ...
    <ol>
      ...
      <li>
        <span>2</span>
        <a href="#guide_second">Finding the right home</a>
      </li>
      <li>
        <span>3</span>
        <a href="#guide_third">Buying a home</a>
      </li>
      <li>
        <span>4</span>
        <a href="#guide_fourth">Home loans explained</a>
      </li>
      <li>
        <span>5</span>
        <a href="#guide_fifth">Applying for a home loan</a>
      </li>
      <li>
        <span>6</span>
        <a href="#guide_sixth">Home loans for different types of employment</a>
      </li>
      <li>
        <span>7</span>
        <a href="#guide_seventh">Bank home loan review</a>
      </li>
    </ol>
