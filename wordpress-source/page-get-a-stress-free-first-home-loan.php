...
<div id="main-content" class="lp">
    ...
    <div class="container">
      <div class="lp-header__inner">
        <div class="lp-header__left">
          <h1 class="lp-header__title lp-header__title--desk"><span>Get</span> a stress-free <span>first home loan</span> with <span>0% brokerage fee</span></h1>
          <div class="lp-header__description">
            <p>Your first home is closer than you think. </p>
            <p>With <img src="<?php echo esc_attr($checkmarkImgURL) ?>" alt="checkmark"> <span>97% approval rate</span> and <br class="mobile"><span>35+ years of expertise</span> <img src="<?php echo esc_attr($checkmarkImgURL) ?>" alt="checkmark"> we provide <br class="desktop">tailored loan options and expert guidance, smoothing the path to your first home.</p>
          </div>
          <div class="lp-header__action">
            <a href="/mortgage-calculator/" class="lp-header__btn btn_yellow"><span class="desktop">Get Pre-Approved Today</span><span class="mob">Calculate my borrowing capacity</span></a>
          </div>
          <div class="lp-header__rating">
            <?php get_template_part('blocks/rating'); ?>
          </div>
        </div>
        <div class="lp-header__right">
          <picture class="lp-header__img">
            <source srcset="<?php echo esc_url($image_path . 'living-room-home-mob.webp') ?>" media="(max-width: 992px)">
            <source srcset="<?php echo esc_url($image_path . 'living-room-home.webp') ?>" media="(min-width: 993px)">
            <img src="<?php echo esc_url($image_path . 'living-room-home.webp') ?>" alt="" width="264" height="500" loading="lazy">

          </picture>
          <h2 class="lp-header__title lp-header__title--mob"><span>Get</span> a stress-free <span>first home loan</span> with <span>0% brokerage fee</span></h2>
          <div class="lp-header__block lp-header__block--buyers lp-buyers-block">
            <div class="lp-buyers-block__img"><img src="<?php echo esc_url($image_path . 'first-time-buyers.webp') ?>" width="104" height="40" /></div>
            <div class="lp-buyers-block__amount">3500+</div>
            <div class="lp-buyers-block__description">We’ve helped over 3,500 first-time buyers secure the
              right loan</div>
          </div>
          <div class="lp-header__block lp-header__block--comment lp-comment-block">
            <div class="lp-comment-block__stars"></div>
            <div class="lp-comment-block__comment">“Joshua and Alex made our home-buying journey smooth and stress-free!“</div>
            <div class="lp-comment-block__author">Marie “Mlive” Livesey</div>
  ...
  <section class="lp__trust lp-trust">
    <div class="container">

      <h2 class="lp-trust__title">Why First-Time Buyers Trust Us</h2>

      <div class="lp-trust__blocks">
        <div class="lp-trust__block trust-block">
          <div class="trust-block__question">Low Deposit?</div>
          <div class="trust-block__ans">No Problem</div>
          <div class="trust-block__description">We help you explore government schemes and lender options, even with as little as
            2-5% deposit.</div>
        </div>
        <div class="lp-trust__block trust-block">
          <div class="trust-block__question">Casual Employment?</div>
          <div class="trust-block__ans">We Have Solutions</div>
          <div class="trust-block__description">Many lenders work with casual and contract workers—let’s find the right one for you.</div>
        </div>
        <div class="lp-trust__block trust-block">
          <div class="trust-block__question">Process Got You Stuck?</div>
          <div class="trust-block__ans">We Simplify It</div>
          <div class="trust-block__description">From pre-approval to settlement, we guide you every step of the way.</div>
        </div>
      </div>

      <div class="lp-trust__actions"><button class="btn_yellow rc_open pum-trigger"> Start Your Free Assessment Now</button></div>
    </div>
  </section>
  <section class="lp__solutions lp-solutions">
    <div class="container">
      <div class="lp-solutions__inner">
        <picture class="lp-solutions__bg">
          <source srcset="<?php echo esc_url($image_path . 'lp-solution-bg-mob.webp') ?>" media="(max-width: 992px)">
          <source srcset="<?php echo esc_url($image_path . 'lp-solution-bg.webp') ?>" media="(min-width: 993px)">
          <img src="<?php echo esc_url($image_path . 'lp-solution-bg.webp') ?>" alt="" width="100%" height="100%" loading="lazy">
        </picture>
        <div class="lp-solutions__content">
          <h2 class="lp-solutions__title">Get Solutions Tailored to Your Situation</h2>
          <div class="lp-solutions__description">
            Your First-time home buyer employment status:
          </div>
          <div class="lp-solutions__accordion">
            <div class="lp-solutions__accordion-item" data-state="open">
              <div class="lp-solutions__accordion-title">
                <h4 class="lp-solutions__accordion-heading">
                  Full-time Employment
                </h4>
                <span class="lp-solutions__accordion-toggle"></span>
              </div>
              <div class="lp-solutions__accordion-content">
                <div class="lp-solutions__accordion-description">
                  <p>Casual employment shouldn’t stop you from owning a home. With a 97% approval rate and experience processing 3,500+ applications, we specialize in securing loans for casual workers. Our access to 30+ banks ensures tailored solutions that fit your income and maximize your borrowing potential</p>
                  <button class="btn_yellow rc_open pum-trigger lp-solutions__accordion-btn ">Get a Free Assessment</button>
                </div>
              </div>
            </div>
            <div class="lp-solutions__accordion-item">
              <div class="lp-solutions__accordion-title">
                <h4 class="lp-solutions__accordion-heading">
                  Contractor Income
            ...
            <div class="lp-solutions__accordion-item">
              ...
              <div class="lp-solutions__accordion-content">
                <div class="lp-solutions__accordion-description">
                  <p>Casual employment can be unpredictable, but your journey to homeownership doesn’t have to be. With a remarkable 97% success rate, we've successfully processed over 3,500 home loan applications for casual employees just like you. Access our expansive network of 30+ lenders to unlock solutions designed specifically around your casual employment status.</p>
                  <button class="btn_yellow rc_open pum-trigger lp-solutions__accordion-btn ">Get a Free Assessment</button>
                </div>
              </div>
            </div>
      ...
      <script>
        document.addEventListener('DOMContentLoaded', function() {
          const accordionItems = document.querySelectorAll('.lp-solutions__accordion-item');
          accordionItems.forEach((item) => {
            item.addEventListener('click', (event) => {
              ...
              if (item.dataset.state === 'open' && !target.closest('button')) {
  ...
  <section class="lp__rent lp-rent">
    <picture class="rent-calc__bg">
      <source srcset="/wp-content/themes/hunter-galloway/assets/img/img_new/dp-calculator-bg-mob.webp" media="(max-width: 992px)">
      <source srcset="/wp-content/themes/hunter-galloway/assets/img/img_new/dp-calculator-bg.webp" media="(min-width: 993px)">
      <img loading="lazy" src="/wp-content/themes/hunter-galloway/assets/img/img_new/dp-calculator-bg.webp" alt="" width="1440" height="657" plerdy-tracking-id="73511441601">
    </picture>
    <div class="container">
      <div class="lp-rent__inner">

        <div class="lp-rent__calc rent-calc">
          <div class="rent-calc__input-screen" data-rent="input" style="display: block">
            <h3 class="rent-calc__title">Your mortgage payment could be lower than your current rent.</h3>
            <div class="rent-calc__block">
              <div class="rent-calc__block-title">Compare your current rent with your mortgage payment</div>
              <form class="rent-calc__form" id="rent-calc-form">

                <div class="rent-calc__input">
                  <label for="rent">What is your weekly rent?</label>
                  <div class="rent-calc__input-wrap">
                    <input id="rent-input" name="rent" placeholder="eg, 400" />
                  </div>
                </div>
                <div class="rent-calc__submit">
                  <button type="submit" class="btn_yellow">Calculate</button>
                </div>
              </form>
            </div>
            <div class="rent-calc__badges">
              <?php get_template_part('blocks/badges'); ?>
            </div>
          </div>
          <div class="rent-calc__result-screen" data-rent="result" style="display: none">
            <h3 class="rent-calc__title">Your mortgage payment could be lower than your current rent.</h3>
            <div class="rent-calc__result-inner">
              <div class="rent-calc__block rent-calc__block--result">
                <div class="rent-calc__block-title">Compare your current rent with your mortgage payment</div>
                <div class="rent-calc__results">

                  <div class="rent-calc__result">
                    <div class="rent-calc__result-title">Your current weekly rent payment is:</div>
                    <div class="rent-calc__result-value">$<span id="weekly-rent-result">0</span></div>
                  </div>
                  <div class="rent-calc__result">
                    <div class="rent-calc__result-title">over 5 years that amounts to a total of</div>
                    <div class="rent-calc__result-value">$<span id="five-year-total-result">0</span></div>
                  </div>
                  <div class="rent-calc__result rent-calc__result--affordable">
                    <div class="rent-calc__result-title">Based on an interest rate of <span>6%</span> you could afford a mortgage of</div>
                    <div class="rent-calc__result-value">$ <span id="affordable-mortgage-result">0</span></div>
                    <div class="rent-calc__result-badge">
                      with the same weekly payments!
                    </div>
                  </div>
                </div>
                <form class="rent-calc__form rent-calc__form--recalc" id="rent-recalc-form">
                  <div class="rent-calc__input">
                    <label for="rent">What is your weekly rent?</label>
                    <div class="rent-calc__input-wrap">
                      <input id="rent-input-recalc" name="rent" placeholder="eg, 400" />
                    </div>
                  </div>
                  <div class="rent-calc__submit">
                    <button type="submit" class="btn_yellow">Recalculate</button>
                  </div>
                </form>
              </div>
              <div class="rent-calc__result-text">

                <div class="rent-calc__block rent-calc__block--yellow">
                  <div class="rent-calc__block-title"><img src="<?php echo esc_url($image_path . 'sm.webp') ?>" alt="" width="44" height="44" loading="lazy"> Why Keep Paying Rent?</div>
                  <div class="rent-calc__block-text">Switch to paying a mortgage that works for YOU!
                    Take the first step to homeownership and find out exactly how much you can borrow today.</div>
                  <div class="rent-calc__block-note">
                    Get your mortgage estimate now and find out how you can start investing in your future!
                  </div>
                  <div class="rent-calc__block-actions">
                    <a href="/mortgage-calculator/" class="btn_yellow">Check My Loan Options Now</a>
                  </div>
                </div>
                <div class="rent-calc__badges">
                  <?php get_template_part('blocks/badges'); ?>
  ...
  <section class="lp__journey lp-journey">
    <div class="container">
      <h2>Journey to Your First Home Loan</h2>
      <div class="lp-journey__steps">
        <div class="lp-journey__step journey-step journey-step--active">
          ...
          <div class="journey-step__title">Free Assessment</div>
          <div class="journey-step__description">We'll analyse your finances and give you a clear picture of what you can realistically afford. It's quick, easy, and the first step towards owning your dream home.</div>
          <div class="journey-step__actions"><button class="header__assessment btn_yellow rc_open pum-trigger">Get a Free Assessment</button></div>
        </div>
        <div class="lp-journey__step journey-step">
          <div class="journey-step__order ">STEP 2</div>
          <div class="journey-step__title">Personalized Plan</div>
          <div class="journey-step__description">You'll receive a personalised plan, developed with our expertise and tailored to your goals, outlining your borrowing power, estimated repayments, and deposit needs.</div>
        </div>
        <div class="lp-journey__step journey-step">
          <div class="journey-step__order ">STEP 3</div>
          <div class="journey-step__title">Information Session</div>
          <div class="journey-step__description">We'll explain everything you need to know about different loan types, interest rates, and fees, helping you to make smart choices. </div>

        </div>
        <div class="lp-journey__step journey-step">
          <div class="journey-step__order ">STEP 4</div>
          <div class="journey-step__title">Next Steps</div>
          <div class="journey-step__description">When you're ready, we'll help you get pre-approved, giving you a clear advantage in your property search. If you've already found your dream home, we can guide you through the full application process.</div>

        </div>
      </div>
  </section>
  <section class="lp__loan lp-loan">
    <div class="container">
      <div class="lp-loan__inner">
        <div class="lp-loan__container">
          <div class="lp-loan__sticky">
            <h2 class="lp-loan__title">Choose your first home buyer employment type and <span>calculate your loan amount</span></h2>
            <div class="lp-loan__block">
              <img src="<?php echo esc_url($image_path . 'nathan_vecchio.webp') ?>" alt="Nathan Vecchio" width="64" height="64" loading="lazy">
              <div>
                <blockquote class="lp-loan__quote">
                  <p>We can work with all employment types, and you might even get a special discount based on your profession.</p>
                </blockquote>
                <p class="lp-loan__quote-author">Nathan Vecchio, Director & Mortgage Broker</p>
              </div>
            </div>
          </div>
        </div>
        <div class="lp-loan__items">
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Full-time Employment</h3>
              <div class="loan-item__text">• Less than one year of experience • More than two years of experience</div>
            </div>
            <div class="loan-item__action"><a href="/mortgage-calculator/" target="_blank">Calculate</a></div>
          </div>
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Contractor Income</h3>
              <div class="loan-item__text">• Mining Contractor • IT Contractor • Construction Contractor • Journalist or Freelancer • Subcontractor...</div>
            </div>
            <div class="loan-item__action"><a href="/home-loan-on-contractor-income/" target="_blank">Calculate</a></div>
          </div>
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Casual Employment</h3>
              <div class="loan-item__text">• Stable casual jobs with irregular hours • Full-time casuals • Part-time casuals • Casual teachers • Casual nurses...</div>
            </div>
            <div class="loan-item__action"><a href="/home-loan-casual-employment/" target="_blank">Calculate</a></div>
          </div>
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Self Employment </h3>
              <div class="loan-item__text">• Less than one year of experience • More than two years of experience </div>
            </div>
            <div class="loan-item__action"><a href="/self-employed-home-loans/" target="_blank">Calculate</a></div>
          </div>
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Lawyers</h3>
              <div class="loan-item__text">• Private lawyers • Self-employed lawyers • Fedral lawyers
                • Judges • Magistrates</div>
            </div>
            <div class="loan-item__action"><a href="/lmi-waiver-lawyers/" target="_blank">Calculate</a></div>
          </div>
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Physiotherapist</h3>
              <div class="loan-item__text">• Geriatric physical therapy • Integumentary • Neurological
                • Orthopedic • Pediatric • Sports • Women’s health...</div>
            </div>
            <div class="loan-item__action"><a href="/physiotherapist-home-loans/" target="_blank">Calculate</a></div>
          </div>
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Accountant</h3>
              <div class="loan-item__text">• Actuary • Auditor • CFO • Director • Finance Director • Finance Manager • Financial Controller • Partner...</div>
            </div>
            <div class="loan-item__action"><a href="/accountant-home-loans/" target="_blank">Calculate</a></div>
          </div>
          <div class="lp-loan__item loan-item">
            <div class="loan-item__content">
              <h3 class="loan-item__title">Pharmacists </h3>
              <div class="loan-item__text">• Pharmacist Clinical Toxicologist • Veterinary Pharmacist • Oncology Pharmacist • Nuclear Pharmacist...</div>
            </div>
            <div class="loan-item__action"><a href="/home-loans-pharmacists/" target="_blank">Calculate</a></div>
          </div>
        </div>
      </div>
    </div>
  </section>
  <section class="lp__boost lp-boost">
    <div class="container">
      <div class="lp-boost__inner">
        <div class="lp-boost__content">
          <h2 class="lp-boost__title">Boost Your Approval Odds</h2>
          <ul class="lp-boost__list">
            <li>Check your credit score & clean up any issues</li>
            <li>Save for at least an 8% deposit (even if 5% is enough)</li>
            <li>Consider a guarantor if you have family support</li>
            <li>Explore government schemes & first-home grants</li>
            <li>Work with an expert to find the right lender for YOU</li>
          </ul>
          <div class="lp-boost__note">Want to know where you stand? Let’s talk</div>
          <div class="lp-boost__actions rc_open pum-trigger">
            <button class="btn_yellow">Get Expert Guidance Today</button>
          </div>
        </div>

        <picture class="lp-boost__bg">
          <source srcset="<?php echo esc_url($image_path . 'hg-mob.webp') ?>" media="(max-width: 992px)">
          <source srcset="<?php echo esc_url($image_path . 'hg.webp') ?>" media="(min-width: 993px)">
          <img src="<?php echo esc_url($image_path . 'hg.webp') ?>" alt="" width="100%" height="100%" loading="lazy">
        </picture>
  ...
  <section class="lp__stories lp-stories">
    <div class="container">
      <h2 class="lp-stories__title">Success Stories from First-Time Buyers</h2>
      <div class="lp-stories__items">
      ...
      <div class="lp-stories__subnote">Join thousands of happy first-home buyers.</div>
  </section>
  <section class="lp__join lp-join">
    <div class="container">
      <div class="lp-join__block join-block">
        ...
        <h2 class="join-block__title">🚀 Your First Home Starts Here. Let’s Make It Happen.</h2>
        <div class="join-block__description">Book Your Free Assessment in 60 Seconds.</div>
        <div class="join-block__actions">
          <a href="/mortgage-calculator/" target="_blank" class="btn_yellow">Check My Loan Options</a>
