...
?>
<div id="main-content" class="nurse-main-content">
    <section class="hero_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h1 class="hero_title">Special Home Loan Offer for Nurses</h1>
                <p class="hero_subtitle">Nurses qualify for discounted interest rates and an LMI waiver up to 85% LVR</p>

                <p class="hero_text">This would save $5,168 on a $500,000 purchase in Queensland, see how much you could save.</p>
                <div class="btn_wrap">
    ...
    <section id="why_choose" class="why_choose why_choose_widget widget">
        <div class="container">
            <div class="inner_widget">
                ...
                <div class="btn_wrap">
                    <a class="btn_yellow rc_open B-trigger" href="#">Request a free strategy assessment</a>
                </div>
            </div>
        </div>
    </section>

    <section class="why_choose why_choose_widget widget">
        <div class="container">
            <div class="inner_widget">
                <div class="why_choose_title">
                    Benefits of a Nurse Home Loan
                </div>
                <div class="why_choose_blocks">
                    <div class="why_choose_blocks_inner flex">
                        <div class="why_choose_item">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/no_lmi.svg">
                            <div class="why_choose_item_title">
                                No LMI on your mortgage
                            </div>
                            <div class="why_choose_item_text">
                        ...
                        <div class="why_choose_item">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/special_discounted.svg">
                            <div class="why_choose_item_title">
                                Special discounted interest rates
                            </div>
                            <div class="why_choose_item_text">
                                up to 1.90% off the standard rate
                            </div>
                        </div>
                        <div class="why_choose_item">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/np_piggy-bank.svg">
                            <div class="why_choose_item_title">
                                Annual package fee waived
                            </div>
                            <div class="why_choose_item_text">
                                for the first year of your loan
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="risk_widget refinance_risk_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">What home loan discounts do nurses get?</h2>

                <p>Nurses are entitled to extra home loan discounts if your borrowing is over $250,000. The actual interest rate discount is going to depend on a few factors including:</p>

                <div class="risk_holder">
                    <div class="risk_inner-left">

                        <ul class="risk_list">
                            <li class="nurse_risk_a">
                                <p class="list_title">Loan amount</p>
                                <p class="list_text">
                                    The larger the loan amount, the larger the discount.
                                </p>
                            </li>

                            <li class="nurse_risk_b">
                                <p class="list_title">Deposit amount</p>
                                <p class="list_text">The less deposit, the higher the LVR. The higher the LVR, the higher the interest rate </p>
                            </li>

                            <li class="nurse_risk_c">
                                <p class="list_title">Professional package</p>
                                <p class="list_text">Most banks offer larger discounts to Nurses who are on their professional packages. Hunter Galloway has arranged to have Nurses’ first-year professional package fee waived, saving up to $400 in the first year.</p>
                            </li>
                    ...
                    <div class="risk_imgwrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/nurse-risk-bg1.png" alt="nurse-home-loan">
                    </div>
                </div>
    ...
    <section class="why_do_widget widget">
        <div class="container">
            <div class="inner_widget">
                ...
                <p class="subtitle">Compare these two options when refinancing your loan</p>
                <div class="why_do_holder">
                    <div class="col_yellow">
                        ...
                        <div class="col_title">
                            <p>Refinance with Hunter Galloway</p>
                        </div>
                    ...
                    <div class="col_dark">
                        ...
                        <div class="col_title">
                            <p>Apply directly to a lender</p>
                        </div>
                        <ul class="why_do_list">
    ...
    <section class="risk_widget refinance_risk_widget refinance_study_risk_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">Case study: Luke and Molly</h2>
                <p>Luke and Molly were able to save <span class="text-bold">$5,033</span> in LMI and and secured a home loan discount of <span class="text-bold">1.86%</span></p>
                <div class="risk_holder">
                    <div class="risk_inner-left">
                        ...
                        <ul class="risk_list">
                            ...
                            <li class="">
                                ...
                                <p class="list_text">We looked into options for Luke and Molly, and given Luke was a Nurse we could have the LMI waived based on an 85% loan. This saved Luke and Molly $5,033 in Lenders Mortgage Insurance and helped them get a home much quicker!</p>
                            </li>
                    ...
                    <div class="risk_imgwrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/nurse-risk-bg2.png" alt="nurse-home-loan">
                    </div>
                </div>
    ...
    <section class="dark_btn_widget widget">
        <div class="container">
            <div class="inner_widget">
                <div class="btn_wrap">
                    <a class="btn_yellow rc_open D-trigger" href="#">Find out if you can get a better rate</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="inner_widget">
                ...
                <div class="accordion_holder">
                    ...
                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">How much can a nurse borrow?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>The following are different thresholds for nurses when it comes to borrowing:</p>
                            <ul class="inner_list">
                                <li>80 percent of the Property Price – If you borrow 80 percent of the total value of a property, you may not be required to pay LMI. But you will need to show a 20 percent deposit, for example, you need to have $200,000 as a deposit amount if you wish to borrow $1,000,000 at an 80 percent loan to value ratio.</li>
                                <li>85 percent of the Property Price – Lending criteria will not be strict and LMI can be waived for Nurses if you wish to take a loan of 85 percent of the property price based on the criteria below.</li>
                                <li>90 percent of the Property Price – If you are able to meet the requirements of a lender, you can also get a 90 percent loan to value ratio. For that, you must repay the debt on a timely basis, must have a 10 percent deposit, stable job and income stream, and good credit history.</li>
                                <li>95 percent of the Property Price – To qualify for a 95 percent loan to value ratio, you need to have a reasonable salary, stable job, good credit history, minimal debt, and you should not be purchasing an unusual type of property in a distant location.</li>
                                <li>More than 95 percent Loan to Value Ratio – If you go for Guarantor home loans, there is also a possibility of getting a home loan that equals 105 percent of the property value. It allows you to avoid LMI payments and you do not even have to fulfill any deposit requirements.
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">What deposit do I need?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>You need to have a minimum deposit of up to 5 percent of the property value and an additional 3-5 percent will be required to meet other costs related to your purchase. The other costs include LMI, conveyancing fee, government fee (stamp duty), etc.</p>
                            <p>In case of an insufficient deposit, there are other home loan packages as well, including guarantor home loans.</p>
                        </div>
                    </div>

                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">How much does Lenders Mortgage Insurance cost?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>The cost of Lenders Mortgage Insurance is based on a sliding scale.The lower your deposit, the more the lenders mortgage insurance costs. The higher your deposit, the less lenders mortgage insurance costs.</p>
                            ...
                            <p class="under-list">As you can see, having no LMI up to 85% avoids costs of up to $9,146.</p>
                        </div>
                    </div>

                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">How do nurses get no Lenders Mortgage Insurance?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>So many lenders consider nurses to be low-risk professionals. This is the reason why most nurse practitioners qualify for waived LMI.</p>
                            <p>To qualify for over 80 percent, however, you have to meet additional requirements that are as follows:</p>
                            ...
                            <ul class="inner_list">
                                ...
                                <li>You hold a good credit rating, with no defaults</li>
                                <li>You have a stable job and a reasonable stream of income</li>
                                <li>You have been in your current job for over 2 years</li>
                                <li>You are looking at purchasing a home</li>
                            </ul>
                        </div>
                    </div>

                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">Can I get a home loan if I’m on probation?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>It can be a little bit more challenging to get a home loan on probation, but it is still possible.
                                You may still be able to borrow up to 95% of the property value as long as you meet all other standard bank lending criteria. This includes having a clean credit history.</p>
                            <p>We recommend applying for a home loan only if you’re certain that your employment is stable.</p>
                        </div>
                    </div>

                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">Will lenders consider my overtime income?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>Lenders will typically consider only 50-80% of overtime income for regular borrowers, which can significantly reduce your borrowing power. Since nurses are essential services workers, some lenders will accept 100% of your overtime income.</p>
                            <p>In order to have 100% of your overtime income considered, you’ll need to provide the following:</p>
                            <ul class="inner_list">
                                <li>An employment letter confirming that you have been receiving overtime income regularly for the past one or two years</li>
                                <li>Two of your most recent payslips</li>
                                <li>Your most recent group certificate</li>
                            </ul>
                        </div>
                    </div>

                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">Will lenders consider fringe benefits as income?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>In many cases, nurses receive a portion of their income in the form of fringe benefits. Many lenders make the mistake of including your fringe benefits as taxable income. This can greatly reduce the amount you’re eligible to borrow.</p>
                            <p>Luckily, there are some lenders that consider this income as tax-free income. Talk to one of our friendly brokers at Hunter Galloway to find out which lenders will do this for you.</p>
                        </div>
                    </div>

                    <div class="et_pb_module et_pb_toggle et_pb_toggle_close">
                        <h5 class="et_pb_toggle_title">Will the banks consider second job income?</h5>
                        <div class="et_pb_toggle_content clearfix">
                            <p>Of course! Being a nurse, it is very common to have a second job to increase your income. This can be from another hospital, or even in another field like aged care or as a trainer.</p>
                            <p>If you can show that you have a 6-12 month work history with your second employer and have been earning a regular income, some lenders will accept 100% of your second job income. Otherwise, they may only consider 50-80% of your second job income.</p>
                            <p>To use this income you will need:</p>
                            <ul class="inner_list">
                                <li>Your 2 most recent payslips</li>
                                <li>Your most recent year’s PAYG group certificate</li>
                            </ul>
                        </div>
                    </div>
