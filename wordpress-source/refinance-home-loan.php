...
Template name: Refinance home loan
...
?>
<div id="main-content" class="refinance-main-content">
    <section class="hero_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h1 class="hero_title">The RBA has cut interest rates twice this year <br> Has your bank done the same for you?</h1>

                <p class="hero_subtitle">If you have had your home loan for over 2 years, you may be on an <br>  uncompetitive interest rate.</p>
                <p class="hero_text">Find out how much you can save</p>
                <div class="btn_wrap">
    ...
    <section class="refinance_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">Refinance now and you could be<br> eligible for up to $4,000 cash back<span class="small_text">*</span></h2>
                <p>Did you know that some banks will actually <span class="text-bold">give you money</span> to refinance your mortgage with them?</p>
                <p class="inner_text">Sometimes you <span class="text-italic">can</span> have your cake and eat it too</p>
                <p> Competition between the banks is at an all-time high. You can benefit by switching to a<br> lender that has a competitive interest rate and a cash rebate.</p>

                <div class="refinance_inner flex">
                    <div class="refinance_item">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/refinance_1.svg">
                        <div class="item_title">
                            Cash Rebate
                        </div>
                    </div>

                    <div class="refinance_plus"></div>

                    <div class="refinance_item">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/refinance_2.svg">
                        <div class="item_title">
    ...
    <section class="risk_widget refinance_risk_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">Why should I refinance my loan?</h2>
                <div class="risk_holder">
                    <div class="risk_inner-left">

                        <ul class="risk_list">
                            <li class="refinance_risk_a">
                            ...
                            <li class="refinance_risk_b">
                                <p class="list_title">Consolidate your debt</p>
                                <p class="list_text">Pay out your credit card and personal loans under your mortgage. Pay off all of your deebts with one home loan repayment and a single, lower interest rate. </p>
                            </li>

                            <li class="refinance_risk_c">
                                <p class="list_title">Increase your loan and take cash out</p>
                                <p class="list_text">Has your house now gone up in value? Refinance your home loan to get access to some extra cash for investment or personal use.</p>
                            </li>

                            <li class="refinance_risk_d">
                                <p class="list_title">Renovate your home</p>
                                <p class="list_text">Kitchen or bathroom looking a little tired? Acess your home equity to fund some renovations and give your home a new lease on life.</p>
                            </li>
                    ...
                    <div class="risk_imgwrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/refinance-home-loan 1.png" alt="refinance-home-loan">
                    </div>
                </div>
    ...
    <section id="why_choose" class="why_choose why_choose_widget widget">
        <div class="container">
            <div class="inner_widget">
                ...
                <div class="why_choose_blocks">
                    <div class="why_choose_blocks_inner flex">
                        <div class="why_choose_item">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/refinance_choose1.svg">
                        ...
                        <div class="why_choose_item">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/refinance_choose2.png">
                            <div class="why_choose_item_title">
                        ...
                        <div class="why_choose_item">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/refinance_choose3.svg">
                            <div class="why_choose_item_title">
                ...
                <div class="btn_wrap">
                    <a class="btn_yellow rc_open B-trigger" href="#">Book your free Home Loan Health check</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="risk_widget refinance_risk_widget refinance_study_risk_widget widget">
        <div class="container">
            <div class="inner_widget">
                <h2 class="inner_title">Case study: Mark and Joanna</h2>
                <p>Mark and Joanna were able to save <span class="text-bold">$6,500</span> per year on their loan repayments and received a cash rebate of <span class="text-bold">$9,000.</span></p>
                <div class="risk_holder">
                    <div class="risk_inner-left">
                        ...
                        <ul class="risk_list">
                            ...
                            <li class="">
                                ...
                                <p class="list_text">They came to Hunter Galloway for a second opinion. We reviewed their situation and saw that their rates were pretty far outside the market. Here’s what we were able to negotiate for them:</p>
                                <div class="list_text_holder">
                                    <p><span class="text-bold">Original home loan rate:</span> 3.00%.</p>
                                    <p><span class="text-bold"> Refinanced home loan rate:</span> 2.78% (saving 0.22%) </p>
                                    <p><span class="text-bold">Original investment loan rate:</span> 3.84%</p>
                                    <p><span class="text-bold"> Refinanced investment loan rate:</span> 3.33% (saving 0.51%)</p>
                                </div>
                                <p>
                    ...
                    <div class="risk_imgwrap">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/refinance-home-loan 2.png" alt="refinance-home-loan">
                    </div>
                </div>
    ...
    <section class="dark_btn_widget widget">
        <div class="container">
            <div class="inner_widget">
                <div class="btn_wrap">
                    <a class="btn_yellow rc_open G-trigger" href="#">Find out if you can get a better rate</a>
                </div>
            </div>
        </div>
    </section>
