...
@media (max-width: 767px) {
  ...
  <script>
      ...
      document.addEventListener(
        'wpcf7mailsent',
        function (event) {
          console.log('Fire form!', event);
          if (jQuery('.dark_bg').hasClass('active')) {
            jQuery('.popup__body > p').text('We’re looking forward to meeting you and help you find the right loan for your needs.');
            jQuery('.popup__body .wpcf7').remove();
            jQuery('.popup__home').css('display', 'flex');
          }
        },
        false
      );
  ...
  <div class="dark_bg">
    <div class="popup">
      ...
      <div class="popup__body">
        ...
        <?php echo do_shortcode('[contact-form-7 id="11832" title="Form in popup"]'); ?>
