...
<style>
  ...
  .third_block>ol::before {
    ...
    width: 100%;
    height: 85%;
    background: url("<?php echo get_template_directory_uri(); ?>/images/guide/refinancers_line.svg");
  ...
  #guide_first>div .img_wrap {
    max-width: 370px;
    width: 53%;
  }

  #guide_first>div>div:not(.img_wrap) {
    width: 53%;
  }

  .third_block ul.sub_list li {
    width: 100%;
  }

  #guide_employment ul.sub_list li,
  #guide_review ul.sub_list li {
    width: 48%;
  }

  #guide_second>div .img_wrap {
    margin-right: 30px;
  }

  #guide_third>div .img_wrap {
    max-width: 431px;
    width: 53%;
  }

  #guide_third>div>div:not(.img_wrap) {
    width: 47%;
  }

  #guide_review>div .img_wrap {
    margin: 30px 0 0;
    max-height: 135px;
  }
  ...
  #guide_employment div ul.sub_list li:nth-child(1) {
    order: 1;
  }

  #guide_employment div ul.sub_list li:nth-child(2) {
    order: 3;
  }

  #guide_employment div ul.sub_list li:nth-child(3) {
    order: 5;
  }

  #guide_employment div ul.sub_list li:nth-child(4) {
    order: 7;
  }

  #guide_employment div ul.sub_list li:nth-child(5) {
    order: 9;
  }

  #guide_employment div ul.sub_list li:nth-child(6) {
    order: 2;
  }

  #guide_employment div ul.sub_list li:nth-child(7) {
    order: 4;
  }

  #guide_employment div ul.sub_list li:nth-child(8) {
    order: 6;
  }

  #guide_employment div ul.sub_list li:nth-child(9) {
    order: 8;
  }

  #guide_employment div ul.sub_list li:nth-child(10) {
    order: 10;
  }

  #guide_review div ul.sub_list li:nth-child(1) {
    order: 1;
  }

  #guide_review div ul.sub_list li:nth-child(2) {
    order: 3;
  }

  #guide_review div ul.sub_list li:nth-child(3) {
    order: 5;
  }

  #guide_review div ul.sub_list li:nth-child(4) {
    order: 7;
  }

  #guide_review div ul.sub_list li:nth-child(5) {
    order: 9;
  }

  #guide_review div ul.sub_list li:nth-child(6) {
    order: 11;
  }

  #guide_review div ul.sub_list li:nth-child(7) {
    order: 13;
  }

  #guide_review div ul.sub_list li:nth-child(8) {
    order: 2;
  }

  #guide_review div ul.sub_list li:nth-child(9) {
    order: 4;
  }

  #guide_review div ul.sub_list li:nth-child(10) {
    order: 6;
  }

  #guide_review div ul.sub_list li:nth-child(11) {
    order: 8;
  }

  #guide_review div ul.sub_list li:nth-child(12) {
    order: 10;
  }

  #guide_review div ul.sub_list li:nth-child(13) {
    order: 12;
  }
...
<section class="guide_box">
  <div class="first_block">
    <div>
      <div>
        <h1>The ultimate guide for refinancing your home loans</h1>
        <p>Everything you need to know about refinancing your home loan.</p>
      </div>
      <div class="img_wrap">
    ...
    <div>
      <p>If you’re thinking about refinancing your home loan, you’re in the right place! </p>
      <p>In this guide we’ll cover everything you need to know about getting your home loan refinanced.</p>
    </div>
  </div>
  <div class="second_block">
    ...
    <ol>
      <li>
        <span>1</span>
        <a href="#guide_first">Should you refinance your home loan?</a>
      </li>
      <li>
        <span>2</span>
        <a href="#guide_second">Home loans explained</a>
      </li>
      <li>
        <span>3</span>
        <a href="#guide_third">Applying for a home loan</a>
      </li>
      <li>
        <span>4</span>
        <a href="#guide_employment">Home loans for different types of employment</a>
      </li>
      <li>
        <span>5</span>
        <a href="#guide_review">Bank home loan reviews</a>
      </li>
    </ol>
<!--     <p>Want to read all info in one place? Check our handy <a href="/first-home-buyer-guide/">first-time home buyer guide.</a></p> -->
  ...
  <div class="third_block">
    <ol>
      <li id="guide_first">
        <h3>Should you refinance your home loan?</h3>
        <div>
          <div class="img_wrap">
          ...
          <div>
            <p>Why would you refinance your home loan? And when is the right time to do so? These resources will help you decide if you should refinance your loan:</p>
            <ul class="sub_list">
              <li>
                <a target="_blank" href="/equity-calculator/">Equity calculator: how to work out your usable equity</a>
              </li>
              <li>
                <a target="_blank" href="/reasons-to-refinance-home-loan/">7 reasons to refinance your home loan in 2022</a>
              </li>
              <li>
                <a target="_blank" href="/removing-a-guarantor-from-mortgage/">Removing a Guarantor from a mortgage</a>
              </li>
              <li>
                <a target="_blank" href="/using-equity-to-buy-a-second-property/">Using equity to buy a second property</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <li id="guide_second">
        ...
        <div>
          <div class="img_wrap">
            <img class="desk_photo" src="<?php echo get_template_directory_uri(); ?>/images/guide/guide_box_photo4.jpg" alt="house" />
            <img class="mob_photo" src="<?php echo get_template_directory_uri(); ?>/images/guide/guide_box_photo_mob4.jpg" alt="house" />
          </div>
          <div>
            <p>Fixed rates, LVR, LMI, offest or redraw - home loan terminology can be confusing. If you need a refresher on what these terms mean, these resources will help you:</p>
            <ul class="sub_list">
              <li>
      ...
      <li id="guide_third">
        ...
        <div>
          <div class="img_wrap">
            <img class="desk_photo" src="<?php echo get_template_directory_uri(); ?>/images/guide/guide_box_photo5.jpg" alt="house and fence" />
            <img class="mob_photo" src="<?php echo get_template_directory_uri(); ?>/images/guide/guide_box_photo_mob5.jpg" alt="house and fence" />
          </div>
          <div>
            <p>
              How does the home loan process work? And what happens if your loan gets declined, or the valuation comes in lower than you expected? We answer your questions below:
            </p>
            <ul class="sub_list">
              <li>
  ...
  function scrolling(upSelector) {
    ...
    links.forEach((link) => {
      link.addEventListener("click", function(event) {
        ...
        //   speed = 0.4
        // } else if (hash === "#guide_review" || hash === "#guide_sixth" || hash === "#guide_seventh" || hash === "#guide_eighth") {
        //   speed = 0.5
        // }
