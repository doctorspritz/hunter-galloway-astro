<?php
/*
 * Template Name: Deposit calculator Template
...
<style>
	@import url('<?php echo (get_stylesheet_directory_uri() . '/assets/css/calculator-page.css') ?>');
</style>

<div class="container" data-calculate-value="<?php echo esc_attr($et_pb_calculate_value); ?>">
	<?php include('sections/calculate-deposit.php'); ?>
	<div id="main-content">
