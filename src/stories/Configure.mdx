...
<Meta title="Setup/Readme" />

<div className="sb-container">
  <div className='sb-section-title'>
    # Storybook consolidated

    Root Storybook is the single source of truth. Stories live under `src/components/**`. The nested CI demo app forwards to this instance.
  </div>
